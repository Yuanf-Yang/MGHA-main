from model_ml_dhd import Transformer, MultiLevelTransformer
...
def parser_add_main_args(parser):
    ...
    # Original single-level parameter
    parser.add_argument('--num_centroids', type=int, default=64)

    # Multi-level parameters
    parser.add_argument('--num_centroids_list', type=int, nargs='+',
                        default=[32, 8, 2],
                        help='Number of centroids at each hierarchy level')
    parser.add_argument('--use_dynamic_gate', action='store_true', default=False,
                        help='Use dynamic node-adaptive gating')
    parser.add_argument('--no_dynamic_gate', action='store_true', default=False,
                        help='Disable dynamic gate (use static weights)')
